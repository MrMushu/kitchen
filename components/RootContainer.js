...
class RootContainer extends React.Component {
  constructor(props) {
    ...
    this.menuToggles = this.menuToggles.bind(this);
  ...
  checkOrders() {
    ...
    if (this.state.checkLimit === false) {
      ...
      var totalOrders = this.props.tickets.pending.concat(
        this.props.tickets.completed
      );
  ...
  render() {
    ...
    return (
      <View style={{ height: "100%" }}>
        ...
        >
          <Tickets width={this.state.width} display8={this.state.display8} />
