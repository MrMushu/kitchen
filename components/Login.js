...
class Login extends React.Component {
  ...
  handlePressAsync = async () => {
    ...
    let result = await AuthSession.startAsync({
      authUrl: `https://sandbox.dev.clover.com/oauth/authorize?client_id=BHQ5NARB3RR3C&state=${redirectUrl}`,
    });
  ...
  render() {
    ...
    return (
      ...
      >
        ...
        >
          <Image
            source={require("../pngs/splash.png")}
            resizeMode={"contain"}
            style={{ width: "100%", alignSelf: "center", position: "absolute" }}
          />
          <View style={{ width: "60%", alignSelf: "center" }}>
            <Image
              source={require("../pngs/aspect.png")}
              resizeMode={"contain"}
              style={{
                width: "60%",
                alignSelf: "center",
          ...
          >
            ...
            >
              ...
              <View style={{ padding: 12, justifyContent: "flex-end" }}>
                <Text style={{ textAlign: "center" }}>Sign-up today -></Text>
              </View>
            </View>
          </View>
        </AnimatedContainer>
